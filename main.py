...
from src.Controller.ProductHistoryController import ProductHistoryController
...
if __name__ == '__main__':
    ...
    seenController = SeenController(view, model)
    productHistoryController = ProductHistoryController(view, model)
